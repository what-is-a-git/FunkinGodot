...
func on_process(delta: float) -> void:
	iconP1.scale.x = lerp(iconP1.scale.x, 1.0, v(0.5,delta))
	iconP2.scale.x = lerp(iconP2.scale.x, 1.0, v(0.5,delta))
	
	iconP1.scale.y = lerp(iconP1.scale.y, 1.0, v(0.5,delta))
	iconP2.scale.y = lerp(iconP2.scale.y, 1.0, v(0.5,delta))
	
	iconP1.offset.x = lerp(iconP1.offset.x, 0.0, v(0.5,delta))
	iconP1.offset.y = lerp(iconP1.offset.y, 0.0, v(0.5,delta))
	
	iconP2.offset.x = lerp(iconP2.offset.x, 0.0, v(0.5,delta))
	iconP2.offset.y = lerp(iconP2.offset.y, 0.0, v(0.5,delta))
